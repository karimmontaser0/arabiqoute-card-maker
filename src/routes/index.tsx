...
const QuoteCard = (() => {
  const Comp = (
    ...
    <div
      ...
      style={{
        ...
        display: "flex",
        flexDirection: "row-reverse", // photo on left visually since flex reverses
        position: "relative",
        overflow: "hidden",
      }}
    >
      {/* Left: Photo (42%) — placed via row-reverse so the photo is on the LEFT */}
  ...
  return Object.assign(
    (props: Omit<Parameters<typeof Comp>[0], "innerRef"> & { ref?: React.Ref<HTMLDivElement> }) => {
      const { ref, ...rest } = props as typeof props & { ref?: React.Ref<HTMLDivElement> };
      return <Comp {...rest} innerRef={ref as React.Ref<HTMLDivElement>} />;
    }
  );
})();
